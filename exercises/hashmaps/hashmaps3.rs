...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        // Closures haven't been introduced at this point yet but this is
        // so much more stomachable than doing everything by hand
        let mut team_1 = scores
